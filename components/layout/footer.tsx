...
const footerLinks = {
  ...
  designers: [
    ...
    { label: 'Become a Designer', href: '/designers/signup' },
    { label: 'Designer Showcase', href: '/designers/showcase' },
    ...
    <footer className="bg-gray-900 dark:bg-gray-950 text-gray-300">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          <div className="col-span-2">
            ...
            <p className="mt-4 text-sm text-gray-400 max-w-xs">
              ...
              Give old items new life with creative transformations.
            </p>
          ...
          <div>
            <h3 className="font-semibold text-white mb-4">Designers</h3>
            <ul className="space-y-3">
              {footerLinks.designers.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm hover:text-emerald-400 transition-colors">
                    {link.label}
                  </Link>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-sm text-gray-500">
          <p>&copy; {new Date().getFullYear()} UpCycle. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
